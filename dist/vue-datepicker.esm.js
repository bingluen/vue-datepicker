...
var __vue_staticRenderFns__ = [];
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-2d97223b_0", { source: "label[data-v-2d97223b]{cursor:inherit}svg[data-v-2d97223b]{display:flex;font-size:1em;height:1em;width:.875em;overflow:visible;vertical-align:-.125em;margin-bottom:2px}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-2d97223b";
  /* module identifier */
...
function getLocale(lang) {
  return isValidLocale(lang) ? lang : locales[lang] || undefined;
}
  ...
  computed: {
    ...
    dateFormatted: function dateFormatted() {
      ...
      if (this.range && this.rangeInputText) {
        ...
        return this.rangeInputText.replace(DATE_HEADER_REGEX, "".concat(startDate)).replace(DATE_HEADER_REGEX, "".concat(endDate));
      } // If type is quarter,
...
var __vue_staticRenderFns__$1 = [];
  ...
  var __vue_inject_styles__$1 = function (inject) {
    if (!inject) { return }
    inject("data-v-7a2e9fbe_0", { source: "button[data-v-7a2e9fbe]{border:none;margin:0;padding:0;width:auto;overflow:visible;background:0 0;color:inherit;font:inherit;line-height:normal;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none}button[data-v-7a2e9fbe]:active,button[data-v-7a2e9fbe]:focus{outline:0;box-shadow:0}button[role=button][data-v-7a2e9fbe],button[type=button][data-v-7a2e9fbe],button[type=reset][data-v-7a2e9fbe],button[type=submit][data-v-7a2e9fbe]{cursor:pointer}.datepicker-input[data-v-7a2e9fbe]{position:relative;display:flex;flex-direction:row;justify-content:flex-start;align-items:center}.datepicker-input--disabled[data-v-7a2e9fbe]{cursor:not-allowed}.datepicker-container--rtl .datepicker-input[data-v-7a2e9fbe]{direction:rtl}.datepicker-container--rtl .datepicker-input button[data-v-7a2e9fbe],.datepicker-container--rtl .datepicker-input input[type=text][data-v-7a2e9fbe]{margin:0 8px 0 0}.datepicker-container--rtl .datepicker-input--no-calendar-icon button[data-v-7a2e9fbe],.datepicker-container--rtl .datepicker-input--no-calendar-icon input[type=text][data-v-7a2e9fbe],.datepicker-input--no-calendar-icon button[data-v-7a2e9fbe],.datepicker-input--no-calendar-icon input[type=text][data-v-7a2e9fbe]{margin:0}input[type=hidden][data-v-7a2e9fbe]{position:absolute;bottom:0;left:50%;height:1px;width:1px;border:0;clip:rect(0 0 0 0);margin:-1px;padding:0;outline:0;-webkit-appearance:none;overflow:hidden}input[type=text][data-v-7a2e9fbe]{cursor:pointer;border:none;box-shadow:none;outline:0;font-size:16px;line-height:19px;margin-left:8px;font-family:inherit;background:0 0}input[type=text][data-v-7a2e9fbe]:active,input[type=text][data-v-7a2e9fbe]:focus{outline:0;box-shadow:none}input[type=text][data-v-7a2e9fbe]:disabled,input[type=text][disabled][data-v-7a2e9fbe]{cursor:not-allowed}input[type=text].placeholder[data-v-7a2e9fbe]{color:rgba(0,0,0,.4)}input[type=text][data-v-7a2e9fbe]::placeholder{color:rgba(0,0,0,.4)}input[type=text][data-v-7a2e9fbe]:-moz-placeholder{color:rgba(0,0,0,.4)}input[type=text][data-v-7a2e9fbe]::-moz-placeholder{color:rgba(0,0,0,.4)}input[type=text][data-v-7a2e9fbe]:-ms-input-placeholder{color:rgba(0,0,0,.4)}input[type=text][data-v-7a2e9fbe]::-webkit-input-placeholder{color:rgba(0,0,0,.4)}.datepicker-input--range input[type=text][data-v-7a2e9fbe]{min-width:310px}button[data-v-7a2e9fbe]{font-size:16px;line-height:19px;margin-left:8px}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$1 = "data-v-7a2e9fbe";
  /* module identifier */
...
var __vue_staticRenderFns__$2 = [];
  ...
  var __vue_inject_styles__$2 = function (inject) {
    if (!inject) { return }
    inject("data-v-2722c15b_0", { source: ".datepicker-overlay[data-v-2722c15b]{position:fixed;top:0;left:0;right:0;bottom:0;background-color:rgba(0,0,0,.5)}@media only screen and (min-width:480px){.datepicker-overlay[data-v-2722c15b]{display:none}}.overlay-transition-enter-active[data-v-2722c15b],.overlay-transition-leave-active[data-v-2722c15b]{opacity:1;transition:opacity .3s}.overlay-transition-enter[data-v-2722c15b],.overlay-transition-leave-to[data-v-2722c15b]{opacity:0}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$2 = "data-v-2722c15b";
  /* module identifier */
...
function getElementPosition(element, target, activatorRect, activatorOffsets, spacesAroundParent, placesAvailable, isRtl) {
  ...
  var defaultTopOrigin = isRtl ? 'top right' : 'top left';
  var defaultBottomOrigin = isRtl ? 'bottom right' : 'bottom left';
  ...
  computed: {
    ...
    dateFormatted: function dateFormatted() {
      if (this.range && this.rangeHeaderText) {
        ...
        var _this$rangeHeaderText = this.rangeHeaderText.replace(DATE_HEADER_REGEX, "".concat(startDate, "|")).replace(DATE_HEADER_REGEX, "".concat(endDate, "|")).split('|'),
            _this$rangeHeaderText2 = slicedToArray(_this$rangeHeaderText, 2),
            fromText = _this$rangeHeaderText2[0],
            toText = _this$rangeHeaderText2[1];
...
var __vue_staticRenderFns__$3 = [];
  ...
  var __vue_inject_styles__$3 = function (inject) {
    if (!inject) { return }
    inject("data-v-bc85de6a_0", { source: ".slide-h-next-enter-active[data-v-bc85de6a],.slide-h-next-leave-active[data-v-bc85de6a],.slide-h-prev-enter-active[data-v-bc85de6a],.slide-h-prev-leave-active[data-v-bc85de6a]{position:absolute;transition:transform .3s,opacity .3s}.slide-h-next-enter[data-v-bc85de6a],.slide-h-prev-leave-to[data-v-bc85de6a]{transform:translateX(100%);opacity:0}.slide-h-next-leave-to[data-v-bc85de6a],.slide-h-prev-enter[data-v-bc85de6a]{transform:translateX(-100%);opacity:0}.datepicker--rtl .slide-h-next-enter[data-v-bc85de6a],.datepicker--rtl .slide-h-prev-leave-to[data-v-bc85de6a]{transform:translateX(-100%)}.datepicker--rtl .slide-h-next-leave-to[data-v-bc85de6a],.datepicker--rtl .slide-h-prev-enter[data-v-bc85de6a]{transform:translateX(100%)}.slide-v-next-enter-active[data-v-bc85de6a],.slide-v-next-leave-active[data-v-bc85de6a],.slide-v-prev-enter-active[data-v-bc85de6a],.slide-v-prev-leave-active[data-v-bc85de6a]{position:absolute;transition:transform .3s,opacity .3s}.slide-v-next-enter[data-v-bc85de6a],.slide-v-prev-leave-to[data-v-bc85de6a]{transform:translateY(100%);opacity:0}.slide-v-next-leave-to[data-v-bc85de6a],.slide-v-prev-enter[data-v-bc85de6a]{transform:translateY(-100%);opacity:0}.yearMonth-enter-active[data-v-bc85de6a],.yearMonth-leave-active[data-v-bc85de6a]{position:absolute;transition:opacity .3s}.yearMonth-enter[data-v-bc85de6a],.yearMonth-leave-to[data-v-bc85de6a]{opacity:0}.datepicker-header[data-v-bc85de6a]{color:#fff;padding:16px;display:flex;justify-content:space-between;flex-direction:column;flex-wrap:wrap;line-height:1;min-height:80px;max-height:80px;border-radius:6px 6px 0 0}.datepicker--rtl .datepicker-header[data-v-bc85de6a]{direction:rtl}@media only screen and (min-width:768px){.datepicker-header[data-v-bc85de6a]{min-height:85px;max-height:85px}}.datepicker-header--range .datepicker-header__wrap[data-v-bc85de6a]{flex:1 1 auto;flex-direction:column;justify-content:space-between}.datepicker-header--range .datepicker-header__date[data-v-bc85de6a]{font-size:18px;height:calc(18px + 8px)}@media only screen and (min-width:768px){.datepicker-header--range .datepicker-header__date[data-v-bc85de6a]{font-size:22px;height:calc(22px + 8px)}}.datepicker-header__year[data-v-bc85de6a]{align-items:center;display:inline-flex;font-size:14px;margin-bottom:8px;opacity:.6;transition:opacity .3s}.datepicker-header__year[data-v-bc85de6a]:focus:not(.datepicker-header__year--active),.datepicker-header__year[data-v-bc85de6a]:hover:not(.datepicker-header__year--active){cursor:pointer;opacity:1}.datepicker-header__year--active[data-v-bc85de6a]{opacity:1;cursor:default}.datepicker-header__wrap[data-v-bc85de6a]{position:relative;display:flex;width:100%}.datepicker-header__date[data-v-bc85de6a]{position:relative;display:flex;width:100%;font-size:22px;height:calc(22px + 8px);text-align:left;overflow:hidden;padding-bottom:8px;margin-bottom:-8px;opacity:.6;transition:opacity .3s}.datepicker-header__date[data-v-bc85de6a]:focus:not(.datepicker-header__date--active),.datepicker-header__date[data-v-bc85de6a]:hover:not(.datepicker-header__date--active){cursor:pointer;opacity:1}.datepicker-header__date--active[data-v-bc85de6a]{opacity:1;cursor:default}@media only screen and (min-width:768px){.datepicker-header__date[data-v-bc85de6a]{font-size:24px;height:calc(24px + 8px)}}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$3 = "data-v-bc85de6a";
  /* module identifier */
...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-784620af_0", { source: ".datepicker-controls__label button[data-v-784620af]{border:none;margin:0;padding:0;width:auto;overflow:visible;background:0 0;color:inherit;font:inherit;line-height:normal;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none}.datepicker-controls__label button[data-v-784620af]:active,.datepicker-controls__label button[data-v-784620af]:focus{outline:0;box-shadow:0}.datepicker-controls__label button[role=button][data-v-784620af],.datepicker-controls__label button[type=button][data-v-784620af],.datepicker-controls__label button[type=reset][data-v-784620af],.datepicker-controls__label button[type=submit][data-v-784620af]{cursor:pointer}.slide-h-next-enter-active[data-v-784620af],.slide-h-next-leave-active[data-v-784620af],.slide-h-prev-enter-active[data-v-784620af],.slide-h-prev-leave-active[data-v-784620af]{position:absolute;transition:transform .3s,opacity .3s}.slide-h-next-enter[data-v-784620af],.slide-h-prev-leave-to[data-v-784620af]{transform:translateX(100%);opacity:0}.slide-h-next-leave-to[data-v-784620af],.slide-h-prev-enter[data-v-784620af]{transform:translateX(-100%);opacity:0}.datepicker--rtl .slide-h-next-enter[data-v-784620af],.datepicker--rtl .slide-h-prev-leave-to[data-v-784620af]{transform:translateX(-100%)}.datepicker--rtl .slide-h-next-leave-to[data-v-784620af],.datepicker--rtl .slide-h-prev-enter[data-v-784620af]{transform:translateX(100%)}.slide-v-next-enter-active[data-v-784620af],.slide-v-next-leave-active[data-v-784620af],.slide-v-prev-enter-active[data-v-784620af],.slide-v-prev-leave-active[data-v-784620af]{position:absolute;transition:transform .3s,opacity .3s}.slide-v-next-enter[data-v-784620af],.slide-v-prev-leave-to[data-v-784620af]{transform:translateY(100%);opacity:0}.slide-v-next-leave-to[data-v-784620af],.slide-v-prev-enter[data-v-784620af]{transform:translateY(-100%);opacity:0}.yearMonth-enter-active[data-v-784620af],.yearMonth-leave-active[data-v-784620af]{position:absolute;transition:opacity .3s}.yearMonth-enter[data-v-784620af],.yearMonth-leave-to[data-v-784620af]{opacity:0}.datepicker-controls[data-v-784620af]{position:relative;display:flex;height:48px;text-align:center;position:relative;width:100%}@media only screen and (min-width:768px){.datepicker-controls[data-v-784620af]{height:56px}}.datepicker--rtl .datepicker-controls[data-v-784620af]{direction:rtl}.datepicker-controls__wrapper[data-v-784620af]{position:relative;overflow:hidden;display:flex;justify-content:center;align-items:center;flex:1}.datepicker-controls__month[data-v-784620af],.datepicker-controls__year[data-v-784620af]{position:relative;display:flex;flex:1;align-items:center}.datepicker-controls__month[data-v-784620af]{justify-content:flex-end}.datepicker-controls__year[data-v-784620af]{justify-content:flex-start}.datepicker-controls__year.datepicker-controls__year--center[data-v-784620af]{justify-content:center}.datepicker-controls__label[data-v-784620af]{padding:8px 4px}.datepicker-controls__label button[data-v-784620af]{position:relative;display:flex;font-size:15px;font-weight:500;line-height:15px;padding:0;border:none;outline:0;transition:color .3s}.datepicker-controls__label button[data-v-784620af]:not(:hover):not(:focus){color:rgba(0,0,0,.87)}.datepicker-controls__label button[data-v-784620af]:disabled,.datepicker-controls__label button[disabled][data-v-784620af]{cursor:default;color:rgba(0,0,0,.26)}.datepicker-controls button.datepicker-controls__next[data-v-784620af],.datepicker-controls button.datepicker-controls__prev[data-v-784620af]{position:relative;flex:0 0 40px;height:48px;width:48px;padding:0 0 0 24px;border:none;outline:0;background-color:transparent;user-select:none;cursor:pointer}@media only screen and (min-width:768px){.datepicker-controls button.datepicker-controls__next[data-v-784620af],.datepicker-controls button.datepicker-controls__prev[data-v-784620af]{padding:0 8px 0 8px;height:56px;width:56px}}.datepicker-controls button.datepicker-controls__next[data-v-784620af]:disabled,.datepicker-controls button.datepicker-controls__next[disabled][data-v-784620af],.datepicker-controls button.datepicker-controls__prev[data-v-784620af]:disabled,.datepicker-controls button.datepicker-controls__prev[disabled][data-v-784620af]{cursor:default}.datepicker-controls button.datepicker-controls__next:disabled svg[data-v-784620af],.datepicker-controls button.datepicker-controls__next[disabled] svg[data-v-784620af],.datepicker-controls button.datepicker-controls__prev:disabled svg[data-v-784620af],.datepicker-controls button.datepicker-controls__prev[disabled] svg[data-v-784620af]{fill:rgba(0,0,0,.26)}.datepicker--rtl .datepicker-controls button.datepicker-controls__next[data-v-784620af],.datepicker--rtl .datepicker-controls button.datepicker-controls__prev[data-v-784620af]{transform:rotate(180deg)}.datepicker-controls button.datepicker-controls__next[data-v-784620af]{padding:0 24px 0 0}@media only screen and (min-width:768px){.datepicker-controls button.datepicker-controls__next[data-v-784620af]{padding:0 8px 0 8px}}.datepicker-controls svg[data-v-784620af]{width:24px;height:24px;fill:rgba(0,0,0,.87);vertical-align:middle}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-784620af";
  /* module identifier */
...
var __vue_staticRenderFns__$5 = [];
  ...
  var __vue_inject_styles__$5 = function (inject) {
    if (!inject) { return }
    inject("data-v-394a1ddc_0", { source: ".datepicker-months .datepicker-months__list button[data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button[data-v-394a1ddc],.datepicker-years ul li button[data-v-394a1ddc]{border:none;margin:0;padding:0;width:auto;overflow:visible;background:0 0;color:inherit;font:inherit;line-height:normal;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none}.datepicker-months .datepicker-months__list button[data-v-394a1ddc]:active,.datepicker-months .datepicker-months__list button[data-v-394a1ddc]:focus,.datepicker-months .datepicker-quarters__list button[data-v-394a1ddc]:active,.datepicker-months .datepicker-quarters__list button[data-v-394a1ddc]:focus,.datepicker-years ul li button[data-v-394a1ddc]:active,.datepicker-years ul li button[data-v-394a1ddc]:focus{outline:0;box-shadow:0}.datepicker-months .datepicker-months__list button[role=button][data-v-394a1ddc],.datepicker-months .datepicker-months__list button[type=button][data-v-394a1ddc],.datepicker-months .datepicker-months__list button[type=reset][data-v-394a1ddc],.datepicker-months .datepicker-months__list button[type=submit][data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button[role=button][data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button[type=button][data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button[type=reset][data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button[type=submit][data-v-394a1ddc],.datepicker-years ul li button[role=button][data-v-394a1ddc],.datepicker-years ul li button[type=button][data-v-394a1ddc],.datepicker-years ul li button[type=reset][data-v-394a1ddc],.datepicker-years ul li button[type=submit][data-v-394a1ddc]{cursor:pointer}.slide-h-next-enter-active[data-v-394a1ddc],.slide-h-next-leave-active[data-v-394a1ddc],.slide-h-prev-enter-active[data-v-394a1ddc],.slide-h-prev-leave-active[data-v-394a1ddc]{position:absolute;transition:transform .3s,opacity .3s}.slide-h-next-enter[data-v-394a1ddc],.slide-h-prev-leave-to[data-v-394a1ddc]{transform:translateX(100%);opacity:0}.slide-h-next-leave-to[data-v-394a1ddc],.slide-h-prev-enter[data-v-394a1ddc]{transform:translateX(-100%);opacity:0}.datepicker--rtl .slide-h-next-enter[data-v-394a1ddc],.datepicker--rtl .slide-h-prev-leave-to[data-v-394a1ddc]{transform:translateX(-100%)}.datepicker--rtl .slide-h-next-leave-to[data-v-394a1ddc],.datepicker--rtl .slide-h-prev-enter[data-v-394a1ddc]{transform:translateX(100%)}.slide-v-next-enter-active[data-v-394a1ddc],.slide-v-next-leave-active[data-v-394a1ddc],.slide-v-prev-enter-active[data-v-394a1ddc],.slide-v-prev-leave-active[data-v-394a1ddc]{position:absolute;transition:transform .3s,opacity .3s}.slide-v-next-enter[data-v-394a1ddc],.slide-v-prev-leave-to[data-v-394a1ddc]{transform:translateY(100%);opacity:0}.slide-v-next-leave-to[data-v-394a1ddc],.slide-v-prev-enter[data-v-394a1ddc]{transform:translateY(-100%);opacity:0}.yearMonth-enter-active[data-v-394a1ddc],.yearMonth-leave-active[data-v-394a1ddc]{position:absolute;transition:opacity .3s}.yearMonth-enter[data-v-394a1ddc],.yearMonth-leave-to[data-v-394a1ddc]{opacity:0}.datepicker-year-month[data-v-394a1ddc]{position:absolute;top:0;left:0;right:0;bottom:0;background:#fff}@supports (padding-bottom:constant(safe-area-inset-bottom)){.datepicker-year-month[data-v-394a1ddc]{--safe-area-inset-bottom:constant(safe-area-inset-bottom);padding-bottom:var(--safe-area-inset-bottom)}}@supports (padding-bottom:env(safe-area-inset-bottom)){.datepicker-year-month[data-v-394a1ddc]{--safe-area-inset-bottom:env(safe-area-inset-bottom);padding-bottom:var(--safe-area-inset-bottom)}}.datepicker-years[data-v-394a1ddc]{height:auto;position:relative;z-index:0;flex:1 0 auto;display:flex;flex-direction:column;align-items:center;height:100%}.datepicker-years ul[data-v-394a1ddc]{width:100%;font-size:16px;font-weight:400;list-style-type:none;overflow-y:scroll;-webkit-overflow-scrolling:touch;padding:0;margin:0;text-align:center}.datepicker-years ul li[data-v-394a1ddc]{cursor:pointer;transition:none}.datepicker-years ul li[data-v-394a1ddc]:focus,.datepicker-years ul li[data-v-394a1ddc]:hover{background-color:#eef1f8}.datepicker-years ul li button[data-v-394a1ddc]{position:relative;width:100%;padding:8px 0}.datepicker-years ul li.active button[data-v-394a1ddc]{font-size:26px;font-weight:500;padding:8px 0}.datepicker-years ul li.disabled button[data-v-394a1ddc]{cursor:default;color:rgba(0,0,0,.26)}.datepicker-months[data-v-394a1ddc]{height:auto;overflow:hidden;position:relative;z-index:0;flex:1 0 auto;display:flex;flex-direction:column;align-items:center;height:100%}.datepicker-months .datepicker-months__wrapper[data-v-394a1ddc]{position:relative;display:flex;width:100%;height:100%;padding:0 8px 8px}.datepicker-months .datepicker-months__list[data-v-394a1ddc],.datepicker-months .datepicker-quarters__list[data-v-394a1ddc]{position:absolute;top:0;left:0;right:0;bottom:0;display:grid;grid-template-columns:repeat(3,1fr);grid-template-rows:repeat(4,1fr);grid-gap:8px;width:100%;height:100%;justify-items:center;align-items:center}.datepicker--rtl .datepicker-months .datepicker-months__list[data-v-394a1ddc],.datepicker--rtl .datepicker-months .datepicker-quarters__list[data-v-394a1ddc]{direction:rtl}.datepicker-months .datepicker-months__list button[data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button[data-v-394a1ddc]{position:relative;display:flex;justify-content:center;align-items:center;font-size:12px;padding:0 20px;height:30px;font-size:15px;font-weight:500;border-radius:2px;outline:0;transition:background-color .3s}.datepicker-months .datepicker-months__list button[data-v-394a1ddc]:hover,.datepicker-months .datepicker-quarters__list button[data-v-394a1ddc]:hover{background-color:#eef1f8}.datepicker-months .datepicker-months__list button[data-v-394a1ddc]:disabled,.datepicker-months .datepicker-months__list button[disabled][data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button[data-v-394a1ddc]:disabled,.datepicker-months .datepicker-quarters__list button[disabled][data-v-394a1ddc]{cursor:default;color:rgba(0,0,0,.26)}.datepicker-months .datepicker-months__list button .datepicker-month--current[data-v-394a1ddc],.datepicker-months .datepicker-quarters__list button .datepicker-month--current[data-v-394a1ddc]{position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;width:100%;height:30px;background-color:currentColor}.datepicker-months .datepicker-quarters__list[data-v-394a1ddc]{grid-template-columns:1fr;grid-template-rows:repeat(4,1fr)}.datepicker-months .datepicker-quarters__list button[data-v-394a1ddc]{height:100%;width:100%}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$5 = "data-v-394a1ddc";
  /* module identifier */
...
var __vue_staticRenderFns__$6 = [];
  ...
  var __vue_inject_styles__$6 = function (inject) {
    if (!inject) { return }
    inject("data-v-78a6234f_0", { source: ".datepicker-preset[data-v-78a6234f]{border:none;margin:0;padding:0;width:auto;overflow:visible;background:0 0;color:inherit;font:inherit;line-height:normal;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none}.datepicker-preset[data-v-78a6234f]:active,.datepicker-preset[data-v-78a6234f]:focus{outline:0;box-shadow:0}.datepicker-preset[role=button][data-v-78a6234f],.datepicker-preset[type=button][data-v-78a6234f],.datepicker-preset[type=reset][data-v-78a6234f],.datepicker-preset[type=submit][data-v-78a6234f]{cursor:pointer}.datepicker-presets[data-v-78a6234f]{position:relative;display:flex;padding:16px 24px}@media only screen and (min-width:480px){.datepicker-presets[data-v-78a6234f]{padding:16px 16px 8px}}.datepicker-presets__wrapper[data-v-78a6234f]{position:relative;display:grid;grid-template-columns:repeat(2,1fr);grid-auto-rows:32px;width:100%}@media only screen and (min-width:768px){.datepicker-presets__wrapper[data-v-78a6234f]{grid-auto-rows:32px}}.datepicker-preset[data-v-78a6234f]{position:relative;padding:0 8px;transition:opacity 450ms cubic-bezier(.23,1,.32,1);font-size:14px;line-height:14px;overflow:hidden;border-color:#eef1f8;border-style:solid;border-width:0}.datepicker-preset[data-v-78a6234f]:nth-child(odd){border-width:0 1px 1px 1px}.datepicker-preset[data-v-78a6234f]:nth-child(odd):first-child{border-width:1px}.datepicker-preset[data-v-78a6234f]:nth-child(even){border-width:0 1px 1px 0}.datepicker-preset[data-v-78a6234f]:nth-child(even):nth-child(2){border-width:1px 1px 1px 0}.datepicker-preset__effect[data-v-78a6234f]{position:absolute;top:0;left:0;right:0;bottom:0;opacity:0;transition:opacity 450ms cubic-bezier(.23,1,.32,1);z-index:-1}.datepicker-preset[data-v-78a6234f]:hover:not(.datepicker-preset--disabled){color:#fff}.datepicker-preset:hover:not(.datepicker-preset--disabled) .datepicker-preset__effect[data-v-78a6234f]{opacity:1}.datepicker-preset--selected[data-v-78a6234f]{color:#fff;pointer-events:none}.datepicker-preset--selected .datepicker-preset__effect[data-v-78a6234f]{opacity:1}.datepicker-preset--disabled[data-v-78a6234f]{color:rgba(93,106,137,.2);cursor:not-allowed;pointer-events:none}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$6 = "data-v-78a6234f";
  /* module identifier */
...
/* template */
var __vue_render__$7 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"datepicker-validate"},[_c('button',{staticClass:"datepicker-validate__button",attrs:{"type":"button"},on:{"click":function($event){return _vm.$emit('cancel')}}},[_c('div',{staticClass:"datepicker-validate__effect",style:(_vm.setBackgroundColor(_vm.color))}),_vm._v(" "),_c('div',{staticClass:"datepicker-validate__name"},[_vm._v(_vm._s(_vm.buttonCancel))])]),_vm._v(" "),_c('button',{staticClass:"datepicker-validate__button",style:(_vm.setTextColor(_vm.color)),attrs:{"type":"button","disabled":_vm.isDisabledValidation},on:{"click":function($event){return _vm.$emit('validate')}}},[_c('div',{staticClass:"datepicker-validate__effect",style:(_vm.setBackgroundColor(_vm.color))}),_vm._v(" "),_c('div',{staticClass:"datepicker-validate__name"},[_vm._v(_vm._s(_vm.buttonValidate))])])])};
var __vue_staticRenderFns__$7 = [];

  /* style */
  var __vue_inject_styles__$7 = function (inject) {
    if (!inject) { return }
    inject("data-v-3c1ea8c5_0", { source: ".datepicker-validate__button[data-v-3c1ea8c5]{border:none;margin:0;padding:0;width:auto;overflow:visible;background:0 0;color:inherit;font:inherit;line-height:normal;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none}.datepicker-validate__button[data-v-3c1ea8c5]:active,.datepicker-validate__button[data-v-3c1ea8c5]:focus{outline:0;box-shadow:0}.datepicker-validate__button[role=button][data-v-3c1ea8c5],.datepicker-validate__button[type=button][data-v-3c1ea8c5],.datepicker-validate__button[type=reset][data-v-3c1ea8c5],.datepicker-validate__button[type=submit][data-v-3c1ea8c5]{cursor:pointer}.datepicker-validate[data-v-3c1ea8c5]{position:relative;display:flex;align-items:center;justify-content:flex-end;padding:0 24px 8px 24px}@media only screen and (min-width:768px){.datepicker-validate[data-v-3c1ea8c5]{padding:8px 16px}}.datepicker--rtl .datepicker-validate[data-v-3c1ea8c5]{direction:rtl}.datepicker-validate__button[data-v-3c1ea8c5]{position:relative;display:inline-flex;flex:0 0 auto;align-items:center;justify-content:center;height:36px;min-width:44px;font-size:14px;font-weight:500;border-radius:4px;padding:6px 8px;outline:0;text-transform:uppercase;text-decoration:none;overflow:hidden}.datepicker-validate__button+.datepicker-validate__button[data-v-3c1ea8c5]{margin-left:8px}.datepicker-validate__button:hover:not(:disabled) .datepicker-validate__effect[data-v-3c1ea8c5]{opacity:.1}.datepicker-validate__button[data-v-3c1ea8c5]:disabled,.datepicker-validate__button[disabled][data-v-3c1ea8c5]{color:rgba(0,0,0,.26)!important;cursor:default}.datepicker-validate__effect[data-v-3c1ea8c5]{position:absolute;top:0;left:0;right:0;bottom:0;opacity:0;transition:opacity 450ms cubic-bezier(.23,1,.32,1);z-index:-1}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$7 = "data-v-3c1ea8c5";
  /* module identifier */
...
var script$8 = {
  ...
  watch: {
    ...
    rangeCurrentHoveredDay: function rangeCurrentHoveredDay(newHoveredDay) {
      if (!newHoveredDay) { return; } // Should update mutableDate if
...
var __vue_render__$8 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"datepicker-transition","appear":""},on:{"after-enter":_vm.setActive}},[(_vm.shouldShowAgenda)?_c('div',{directives:[{name:"click-outside",rawName:"v-click-outside",value:({ handler : function () { return _vm.$emit('close'); }, isActive: !_vm.inline && _vm.isActive }),expression:"{ handler : () => $emit('close'), isActive: !inline && isActive }"}],ref:"content",staticClass:"datepicker",class:_vm.classes,style:(_vm.styles),attrs:{"name":"datepicker-slide"},on:{"mousemove":_vm.handleMouseMove,"click":function($event){$event.stopPropagation();}}},[(_vm.fullscreenMobile)?_c('div',{staticClass:"datepicker-title"},[_c('p',[_vm._v(_vm._s(_vm.name))]),_vm._v(" "),_c('button',{attrs:{"type":"button"},on:{"click":function($event){return _vm.$emit('close')}}},[_c('svg',{attrs:{"aria-hidden":"true","focusable":"false","data-prefix":"fal","data-icon":"times","role":"img","xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 320 512"}},[_c('path',{attrs:{"fill":"currentColor","d":"M193.94 256L296.5 153.44l21.15-21.15c3.12-3.12 3.12-8.19 0-11.31l-22.63-22.63c-3.12-3.12-8.19-3.12-11.31 0L160 222.06 36.29 98.34c-3.12-3.12-8.19-3.12-11.31 0L2.34 120.97c-3.12 3.12-3.12 8.19 0 11.31L126.06 256 2.34 379.71c-3.12 3.12-3.12 8.19 0 11.31l22.63 22.63c3.12 3.12 8.19 3.12 11.31 0L160 289.94 262.56 392.5l21.15 21.15c3.12 3.12 8.19 3.12 11.31 0l22.63-22.63c3.12-3.12 3.12-8.19 0-11.31L193.94 256z"}})])])]):_vm._e(),_vm._v(" "),(!_vm.noHeader)?_c('DatePickerHeader',{attrs:{"mutable-date":_vm.mutableDate,"transition-name":_vm.transitionLabelName,"color":_vm.color,"locale":_vm.locale,"format-header":_vm.formatHeader,"mode":_vm.yearMonthMode,"range":_vm.range,"range-header-text":_vm.rangeHeaderText},on:{"showYearMonthSelector":_vm.showYearMonthSelector,"hideYearMonthSelector":_vm.hideYearMonthSelector}}):_vm._e(),_vm._v(" "),(_vm.range)?_c('DatePickerPresets',{attrs:{"range-presets":_vm.rangePresets,"mutable-date":_vm.mutableDate,"min-date":_vm.minDate,"max-date":_vm.maxDate,"color":_vm.color,"locale":_vm.locale},on:{"updateRange":_vm.emitSelectedDate}}):_vm._e(),_vm._v(" "),_c('div',{staticClass:"datepicker-content"},[_c('DatePickerControls',{attrs:{"current-date":_vm.currentDate,"transition-name":_vm.transitionLabelName,"color":_vm.color,"mode":"month"},on:{"changeVisibleDate":_vm.changeMonth,"showYearMonthSelector":_vm.showYearMonthSelector}}),_vm._v(" "),_c('div',{staticClass:"datepicker-week"},_vm._l((_vm.weekDays),function(day,index){return _c('div',{key:index,staticClass:"datepicker-weekday"},[_vm._v("\n          "+_vm._s(day)+"\n        ")])}),0),_vm._v(" "),_c('TransitionGroup',{staticClass:"datepicker-days__wrapper",class:_vm.classWeeks,attrs:{"tag":"div","name":_vm.transitionDaysName}},_vm._l(([_vm.currentDate]),function(dates){return _c('div',{key:dates.month,staticClass:"datepicker-days"},[_vm._l((_vm.spaceBeforeFirstDay),function(day){return _c('div',{key:("space-" + day),staticClass:"datepicker-day"})}),_vm._v(" "),_vm._l((_vm.currentDate.getDays()),function(day,index){return _c('button',{key:index,staticClass:"datepicker-day",class:{
            ...
            },attrs:{"disabled":_vm.isDisabled(day),"data-date":day.format('YYYY-MM-DD'),"type":"button"},on:{"click":function($event){return _vm.selectDate(day)}}},[(_vm.isToday(day))?_c('span',{staticClass:"datepicker-day--current"}):_vm._e(),_vm._v(" "),_c('span',{staticClass:"datepicker-day__effect",style:(_vm.setBackgroundColor(_vm.color))}),_vm._v(" "),_c('span',{staticClass:"datepicker-day__text"},[_vm._v(_vm._s(day.format('D')))])])})],2)}),0),_vm._v(" "),(_vm.shouldShowYearMonthSelector)?_c('DatePickerYearMonth',{attrs:{"mode":_vm.yearMonthMode,"range":_vm.range,"current-date":_vm.currentDate,"mutable-date":_vm.mutableDate,"transition-name":_vm.transitionDaysName,"show-year-month-selector":_vm.showYearMonthSelector,"color":_vm.color,"min-date":_vm.minDate,"max-date":_vm.maxDate},on:{"changeYear":_vm.changeYear,"selectedYearMonth":_vm.selectedYearMonth}}):_vm._e()],1),_vm._v(" "),(_vm.validate)?_c('DatePickerValidate',{attrs:{"button-validate":_vm.buttonValidate,"button-cancel":_vm.buttonCancel,"color":_vm.color,"range":_vm.range,"mutable-date":_vm.mutableDate},on:{"cancel":function($event){return _vm.$emit('close')},"validate":function($event){return _vm.$emit('validateDate')}}}):_vm._e()],1):_vm._e()])};
var __vue_staticRenderFns__$8 = [];

  /* style */
  var __vue_inject_styles__$8 = function (inject) {
    if (!inject) { return }
    inject("data-v-0aa9cc84_0", { source: ".datepicker *,.datepicker ::after,.datepicker ::before{box-sizing:border-box}", map: undefined, media: undefined })
,inject("data-v-0aa9cc84_1", { source: ".datepicker-days .datepicker-day[data-v-0aa9cc84]{border:none;margin:0;padding:0;width:auto;overflow:visible;background:0 0;color:inherit;font:inherit;line-height:normal;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none}.datepicker-days .datepicker-day[data-v-0aa9cc84]:active,.datepicker-days .datepicker-day[data-v-0aa9cc84]:focus{outline:0;box-shadow:0}.datepicker-days .datepicker-day[role=button][data-v-0aa9cc84],.datepicker-days .datepicker-day[type=button][data-v-0aa9cc84],.datepicker-days .datepicker-day[type=reset][data-v-0aa9cc84],.datepicker-days .datepicker-day[type=submit][data-v-0aa9cc84]{cursor:pointer}.slide-h-next-enter-active[data-v-0aa9cc84],.slide-h-next-leave-active[data-v-0aa9cc84],.slide-h-prev-enter-active[data-v-0aa9cc84],.slide-h-prev-leave-active[data-v-0aa9cc84]{position:absolute;transition:transform .3s,opacity .3s}.slide-h-next-enter[data-v-0aa9cc84],.slide-h-prev-leave-to[data-v-0aa9cc84]{transform:translateX(100%);opacity:0}.slide-h-next-leave-to[data-v-0aa9cc84],.slide-h-prev-enter[data-v-0aa9cc84]{transform:translateX(-100%);opacity:0}.datepicker--rtl .slide-h-next-enter[data-v-0aa9cc84],.datepicker--rtl .slide-h-prev-leave-to[data-v-0aa9cc84]{transform:translateX(-100%)}.datepicker--rtl .slide-h-next-leave-to[data-v-0aa9cc84],.datepicker--rtl .slide-h-prev-enter[data-v-0aa9cc84]{transform:translateX(100%)}.slide-v-next-enter-active[data-v-0aa9cc84],.slide-v-next-leave-active[data-v-0aa9cc84],.slide-v-prev-enter-active[data-v-0aa9cc84],.slide-v-prev-leave-active[data-v-0aa9cc84]{position:absolute;transition:transform .3s,opacity .3s}.slide-v-next-enter[data-v-0aa9cc84],.slide-v-prev-leave-to[data-v-0aa9cc84]{transform:translateY(100%);opacity:0}.slide-v-next-leave-to[data-v-0aa9cc84],.slide-v-prev-enter[data-v-0aa9cc84]{transform:translateY(-100%);opacity:0}.yearMonth-enter-active[data-v-0aa9cc84],.yearMonth-leave-active[data-v-0aa9cc84]{position:absolute;transition:opacity .3s}.yearMonth-enter[data-v-0aa9cc84],.yearMonth-leave-to[data-v-0aa9cc84]{opacity:0}.datepicker[data-v-0aa9cc84]{position:absolute;display:flex;flex-direction:column;width:290px;left:0;top:100%;will-change:transform;background-color:#fff;border-radius:6px;box-shadow:0 2px 8px rgba(50,50,93,.2);box-sizing:border-box}.datepicker[data-v-0aa9cc84]:active,.datepicker[data-v-0aa9cc84]:focus{outline:0}@media only screen and (min-width:768px){.datepicker[data-v-0aa9cc84]{width:315px}}.datepicker--inline[data-v-0aa9cc84]{position:relative;box-shadow:0 3px 1px -2px rgba(0,0,0,.2),0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12)}.datepicker--fixed[data-v-0aa9cc84]{position:fixed}@media only screen and (max-width:479px){.datepicker--fullscreen-mobile[data-v-0aa9cc84]{position:fixed;top:auto!important;bottom:0!important;left:0!important;right:0!important;width:100%;border-radius:12px 12px 0 0}@supports (padding-bottom:constant(safe-area-inset-bottom)){.datepicker--fullscreen-mobile[data-v-0aa9cc84]{--safe-area-inset-bottom:constant(safe-area-inset-bottom);padding-bottom:var(--safe-area-inset-bottom)}}@supports (padding-bottom:env(safe-area-inset-bottom)){.datepicker--fullscreen-mobile[data-v-0aa9cc84]{--safe-area-inset-bottom:env(safe-area-inset-bottom);padding-bottom:var(--safe-area-inset-bottom)}}.datepicker--fullscreen-mobile .datepicker-header[data-v-0aa9cc84]{border-radius:0}}.datepicker-title[data-v-0aa9cc84]{position:relative;display:flex;justify-content:space-between;align-items:center;min-height:48px;padding:0 0 0 24px;border-radius:12px 12px 0 0}.datepicker--rtl .datepicker-title[data-v-0aa9cc84]{direction:rtl;padding:0 24px 0 0}@media only screen and (min-width:480px){.datepicker-title[data-v-0aa9cc84]{display:none}}.datepicker-title p[data-v-0aa9cc84]{margin:0}.datepicker-title button[data-v-0aa9cc84]{position:relative;flex:0 0 40px;height:48px;width:48px;padding:0 16px 0 8px;border:none;outline:0;background-color:transparent;user-select:none}@media only screen and (min-width:768px){.datepicker-title button[data-v-0aa9cc84]{height:56px;width:56px}}.datepicker-title button svg[data-v-0aa9cc84]{width:24px;height:24px}.datepicker-content[data-v-0aa9cc84]{position:relative;display:flex;flex-direction:column;flex:1 1 auto}.datepicker-week[data-v-0aa9cc84]{display:flex;font-size:12px;line-height:12px;font-weight:500;margin:8px 24px;color:rgba(0,0,0,.38)}@media only screen and (min-width:768px){.datepicker-week[data-v-0aa9cc84]{margin:8px 16px}}.datepicker--rtl .datepicker-week[data-v-0aa9cc84]{direction:rtl}.datepicker-week .datepicker-weekday[data-v-0aa9cc84]{width:calc((100% / 7) - .1px);text-align:center}@media only screen and (min-width:768px){.datepicker-week .datepicker-weekday[data-v-0aa9cc84]{width:40px}}.datepicker-days__wrapper[data-v-0aa9cc84]{position:relative;height:180px;margin:0 24px 8px;overflow:hidden;transition:height .3s cubic-bezier(.23,1,.32,1)}@media only screen and (min-width:768px){.datepicker-days__wrapper[data-v-0aa9cc84]{margin:0 16px 8px;height:200px}}.datepicker-days__wrapper.has-6-weeks[data-v-0aa9cc84]{height:216px}@media only screen and (min-width:768px){.datepicker-days__wrapper.has-6-weeks[data-v-0aa9cc84]{height:240px}}.datepicker--validate .datepicker-days__wrapper[data-v-0aa9cc84]{margin:0 24px}@media only screen and (min-width:768px){.datepicker--validate .datepicker-days__wrapper[data-v-0aa9cc84]{margin:0 16px}}.datepicker-days[data-v-0aa9cc84]{display:flex;flex-wrap:wrap;overflow:hidden;width:100%}.datepicker--rtl .datepicker-days[data-v-0aa9cc84]{direction:rtl}.datepicker-days .datepicker-day[data-v-0aa9cc84]{position:relative;width:calc((100% / 7) - .1px);height:36px;line-height:1;font-size:12px;float:left;text-align:center;color:rgba(0,0,0,.87);font-weight:500;transition:color 450ms cubic-bezier(.23,1,.32,1);overflow:hidden}@media only screen and (min-width:768px){.datepicker-days .datepicker-day[data-v-0aa9cc84]{width:calc((100% / 7) - .1px);height:40px}}.datepicker-days .datepicker-day[data-v-0aa9cc84]:hover:not(.disabled){color:#fff}.datepicker-days .datepicker-day:hover:not(.disabled) .datepicker-day__effect[data-v-0aa9cc84]{transform:translateX(-50%) scale(1);opacity:.5}.datepicker-days .datepicker-day.between[data-v-0aa9cc84]:not(.disabled),.datepicker-days .datepicker-day.in-range[data-v-0aa9cc84]:not(.disabled){color:#fff}.datepicker-days .datepicker-day.between:not(.disabled) .datepicker-day__effect[data-v-0aa9cc84],.datepicker-days .datepicker-day.in-range:not(.disabled) .datepicker-day__effect[data-v-0aa9cc84]{transform:translateX(-50%);left:0;width:calc(100% + 1px);border-radius:0;opacity:.5}.datepicker-days .datepicker-day.between:not(.disabled) .datepicker-day__effect[data-v-0aa9cc84]:before,.datepicker-days .datepicker-day.in-range:not(.disabled) .datepicker-day__effect[data-v-0aa9cc84]:before{opacity:1;left:50%}.datepicker-days .datepicker-day.selected[data-v-0aa9cc84]{color:#fff}.datepicker-days .datepicker-day.selected:hover:not(.disabled) .datepicker-day__effect[data-v-0aa9cc84]{opacity:1}.datepicker-days .datepicker-day.selected .datepicker-day__effect[data-v-0aa9cc84]{transform:translateX(-50%);opacity:1}.datepicker-days .datepicker-day.first .datepicker-day__effect[data-v-0aa9cc84],.datepicker-days .datepicker-day.select-start:hover:not(.selected) .datepicker-day__effect[data-v-0aa9cc84]{opacity:1}.datepicker-days .datepicker-day.first .datepicker-day__effect[data-v-0aa9cc84]:before,.datepicker-days .datepicker-day.select-start:hover:not(.selected) .datepicker-day__effect[data-v-0aa9cc84]:before{opacity:.5;left:50%}.datepicker--rtl .datepicker-days .datepicker-day.first .datepicker-day__effect[data-v-0aa9cc84]:before,.datepicker--rtl .datepicker-days .datepicker-day.select-start:hover:not(.selected) .datepicker-day__effect[data-v-0aa9cc84]:before{left:-50%}.datepicker-days .datepicker-day.last .datepicker-day__effect[data-v-0aa9cc84],.datepicker-days .datepicker-day.select-end:hover:not(.selected) .datepicker-day__effect[data-v-0aa9cc84]{opacity:1}.datepicker-days .datepicker-day.last .datepicker-day__effect[data-v-0aa9cc84]:before,.datepicker-days .datepicker-day.select-end:hover:not(.selected) .datepicker-day__effect[data-v-0aa9cc84]:before{opacity:.5;left:-50%}.datepicker--rtl .datepicker-days .datepicker-day.last .datepicker-day__effect[data-v-0aa9cc84]:before,.datepicker--rtl .datepicker-days .datepicker-day.select-end:hover:not(.selected) .datepicker-day__effect[data-v-0aa9cc84]:before{left:50%}.datepicker-days .datepicker-day.first.last .datepicker-day__effect[data-v-0aa9cc84]:before{opacity:0}.datepicker-days .datepicker-day.disabled[data-v-0aa9cc84]{cursor:default;color:rgba(0,0,0,.26)}.datepicker-days .datepicker-day.disabled:hover .datepicker-day__effect[data-v-0aa9cc84],.datepicker-days .datepicker-day.disabled:hover .datepicker-day__effect[data-v-0aa9cc84]:before{opacity:0!important}.datepicker-days .datepicker-day--current[data-v-0aa9cc84]{position:absolute;top:1px;left:50%;transform:translateX(-50%);width:34px;height:34px;border-radius:50%;border:1px solid currentColor}@media only screen and (min-width:768px){.datepicker-days .datepicker-day--current[data-v-0aa9cc84]{top:4px;width:36px;height:36px}}.datepicker-days .datepicker-day__effect[data-v-0aa9cc84]{position:absolute;top:1px;left:50%;width:34px;height:34px;border-radius:50%;transition:all 450ms cubic-bezier(.23,1,.32,1);transition-property:transform,opacity;transform:translateX(-50%) scale(0)}@media only screen and (min-width:768px){.datepicker-days .datepicker-day__effect[data-v-0aa9cc84]{top:4px;width:36px;height:36px}}.datepicker--range .datepicker-days .datepicker-day__effect[data-v-0aa9cc84]:before{content:\"\";position:absolute;top:0;left:0;width:100%;height:100%;background-color:inherit;opacity:0}.datepicker--range-selecting .datepicker-days .datepicker-day__effect[data-v-0aa9cc84]{transform:translateX(-50%) scale(0);opacity:0;transition:none}.datepicker-days .datepicker-day__text[data-v-0aa9cc84]{position:relative;vertical-align:sub}.datepicker-transition-enter-active[data-v-0aa9cc84]:not(.datepicker--inline),.datepicker-transition-leave-active[data-v-0aa9cc84]:not(.datepicker--inline){opacity:1;transition:all .3s;transition-property:transform,opacity;transform:scale(1)}@media only screen and (max-width:479px){.datepicker-transition-enter-active:not(.datepicker--inline).datepicker--fullscreen-mobile[data-v-0aa9cc84],.datepicker-transition-leave-active:not(.datepicker--inline).datepicker--fullscreen-mobile[data-v-0aa9cc84]{transform:translateY(0)}}.datepicker-transition-enter[data-v-0aa9cc84]:not(.datepicker--inline),.datepicker-transition-leave-to[data-v-0aa9cc84]:not(.datepicker--inline){opacity:0;transform:scale(0)}@media only screen and (max-width:479px){.datepicker-transition-enter:not(.datepicker--inline).datepicker--fullscreen-mobile[data-v-0aa9cc84],.datepicker-transition-leave-to:not(.datepicker--inline).datepicker--fullscreen-mobile[data-v-0aa9cc84]{transform:translateY(100%)}}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$8 = "data-v-0aa9cc84";
  /* module identifier */
  ...
  computed: {
    ...
    textsFormat: function textsFormat() {
      var _getLocale = getLocale(this.locale.lang),
          buttonValidate = _getLocale.buttonValidate,
          buttonCancel = _getLocale.buttonCancel,
          rangeHeaderText = _getLocale.rangeHeaderText;
...
var __vue_staticRenderFns__$9 = [];
  ...
  var __vue_inject_styles__$9 = function (inject) {
    if (!inject) { return }
    inject("data-v-0c0088e6_0", { source: ".datepicker-container *,.datepicker-container ::after,.datepicker-container ::before{box-sizing:border-box}", map: undefined, media: undefined })
,inject("data-v-0c0088e6_1", { source: ".datepicker-container[data-v-0c0088e6]{position:relative;display:flex;flex-direction:row;align-items:center;width:auto;cursor:pointer;box-sizing:border-box}.datepicker-container[data-v-0c0088e6]:active,.datepicker-container[data-v-0c0088e6]:focus{outline:0}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$9 = "data-v-0c0088e6";
  /* module identifier */
